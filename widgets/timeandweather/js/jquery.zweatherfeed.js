...
(function($){
    ...
    var _tt = []; {
        ...
        _tt[27]   = {'en':'Mostly cloudy (night)', 'de':'&Uuml;berwiegend wolkig',  'ru': 'В основном облачно'};
        ...
        _tt[100]  = {code: 39, 'en':'scattered thunderstorms', 'de': 'vereinzelt Gewitter',   'ru': 'Грозы'};
        _tt[101]  = {code: 32, 'en':'sunny',    'de':'heiter', 						'ru': 'Солнечно'};
